      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: BottomPageUserWidget.routeName,
              path: BottomPageUserWidget.routePath,
              builder: (context, params) => BottomPageUserWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: SignupPageUserWidget.routeName,
              path: SignupPageUserWidget.routePath,
              builder: (context, params) => SignupPageUserWidget(),
            ),
            FFRoute(
              name: SignupPageBrandWidget.routeName,
              path: SignupPageBrandWidget.routePath,
              builder: (context, params) => SignupPageBrandWidget(),
            ),
            FFRoute(
              name: LoginPageUserWidget.routeName,
              path: LoginPageUserWidget.routePath,
              builder: (context, params) => LoginPageUserWidget(),
            ),
            FFRoute(
              name: LoginPageBrandPartnerWidget.routeName,
              path: LoginPageBrandPartnerWidget.routePath,
              builder: (context, params) => LoginPageBrandPartnerWidget(),
            ),
            FFRoute(
              name: SearchPageStudentWidget.routeName,
              path: SearchPageStudentWidget.routePath,
              builder: (context, params) => SearchPageStudentWidget(),
            ),
            FFRoute(
              name: BottomPageBrandPartnerWidget.routeName,
              path: BottomPageBrandPartnerWidget.routePath,
              builder: (context, params) => BottomPageBrandPartnerWidget(),
            ),
            FFRoute(
              name: CommentSectionPageWidget.routeName,
              path: CommentSectionPageWidget.routePath,
              builder: (context, params) => CommentSectionPageWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: UserSignupDetailsWidget.routeName,
              path: UserSignupDetailsWidget.routePath,
              builder: (context, params) => UserSignupDetailsWidget(),
            ),
            FFRoute(
              name: FavpageWidget.routeName,
              path: FavpageWidget.routePath,
              builder: (context, params) => FavpageWidget(),
            ),
            FFRoute(
              name: NewCarbonActivityWidget.routeName,
              path: NewCarbonActivityWidget.routePath,
              builder: (context, params) => NewCarbonActivityWidget(),
            )
