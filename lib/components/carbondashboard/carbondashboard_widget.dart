...
import 'carbondashboard_model.dart';
export 'carbondashboard_model.dart';

class CarbondashboardWidget extends StatefulWidget {
  const CarbondashboardWidget({super.key});
...
class _CarbondashboardWidgetState extends State<CarbondashboardWidget> {
  late CarbondashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarbondashboardModel());
          ...
          children: [
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  context.pushNamed(NewCarbonActivityWidget.routeName);
                },
