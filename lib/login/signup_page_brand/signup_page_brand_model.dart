...
import '/index.dart';
import 'signup_page_brand_widget.dart' show SignupPageBrandWidget;
import 'package:flutter/material.dart';

class SignupPageBrandModel extends FlutterFlowModel<SignupPageBrandWidget> {
  ...
  String? _textController1Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Please enter valid your first name.';
    }
  ...
  String? _textController2Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Please enter valid your last name.';
    }
